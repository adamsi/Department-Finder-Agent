        ...
        <div className="relative z-10 max-w-7xl mx-auto py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="flex items-center justify-center mb-3 sm:mb-4">
              ...
              <span className="text-lg sm:text-xl font-semibold text-white">Department Finder</span>
            </div>
            <p className="text-blue-300 text-sm sm:text-base">© 2026 Department Finder</p>
          </div>
        </div>
      </footer>
    </ScrollReveal>
