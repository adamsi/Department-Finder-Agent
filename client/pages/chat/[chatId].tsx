...
const ChatPage: React.FC = () => {
  ...
  }, [chatId, chats, chatMessages, conversations, router, dispatch, loadChatMessagesFromHook, selectedConversation]);
  ...
  return (
    <>
      <Head>
        <title>{displayConversation.name ? `Department Finder — ${displayConversation.name}` : 'Department Finder'}</title>
        <meta name="description" content="Find the right department using natural language and your uploaded documents." />
        <meta
          name="viewport"
